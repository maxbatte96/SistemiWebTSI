    ...
    <div class="col-12 col-md-8">
        ...
        <div class="row">
            ...
            <form class="col-12 col-xl-4">
                ...
                <ul class="text-danger">
                    <div for="film_selezionato">Film da modificare:</div>
                    ...
                    <li>
                        <div for="titolo">Titolo:</div>
                        <input v-model="movies[selected].Title" class="rounded" type="text" id="titolo"/>    
                    </li>
                    <li>
                        <div for="regista">Regista:</div>
                        <input v-model="movies[selected].Director" class="rounded" type="text" id="regista"/>
                    </li>
                    <li>
                        <div for="anno">Anno:</div>
                        <input v-model="movies[selected].Year" class="rounded" type="text" id="anno"/>    
                    </li>
                </ul>
            </form>
            <form class="col-12 col-xl-4">
                ...
                <ul class="text-danger">
                    <li>
                        <div for="film_selezionato">Film da eliminare:</div>
                        <select id="film_selezionato" class="rounded" v-model="selected">
                        <option v-for="(movie, index) in movies" v-bind:value="index">{{movie.Title}}</option>
                        </select>
                    </li>
                    <button v-on:click="deleteMovie" class="btn btn-outline-danger mt-1" type="button" name="submit" id="submit">Elimina</button>
                </ul>
            </form>
            </div>
        </article>
